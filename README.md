...
![Dataset composition bar chart](images/01_dataset_composition.png)
...
![Best model comparison bar chart](images/02_model_comparison.png)
...
![Error concentration schematic showing the PG-13 to R boundary as the dominant failure mode](images/04_error_concentration.png)
...
![Feature importance horizontal bar chart](images/03_feature_importance.png)
